...
windowBaseline = [2 3];
windowResponse = [4 5];
coa15.esp = collectData(coa15_1.espe, odors, windowBaseline,  windowResponse);
pcx15.esp = collectData(pcx15_1.espe, odors, windowBaseline,  windowResponse);
odors = 1:10;
coaAA.esp = collectData(coaAA_1.espe, odors, windowBaseline,  windowResponse);
pcxAA.esp = collectData(pcxAA_1.espe, odors, windowBaseline,  windowResponse);
...
%% as in Fig 4D
[tuningCurvesCoa15, tuningCurvesSigCoa15] = findTuningCurves(coa15.esp, 1:15, 1, 0);
[tuningCurvesPcx15, tuningCurvesSigPcx15] = findTuningCurves(pcx15.esp, 1:15, 1, 0);
